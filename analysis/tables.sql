...
create table phrase_occurrences (
    ...
    FOREIGN KEY (corpus_id, document_id) REFERENCES documents(corpus_id, document_id) DEFERRABLE,
...
create table similarities (
    ...
    FOREIGN KEY (corpus_id, low_document_id) REFERENCES documents(corpus_id, document_id) DEFERRABLE,
    FOREIGN KEY (corpus_id, high_document_id) REFERENCES documents(corpus_id, document_id) DEFERRABLE,
);
